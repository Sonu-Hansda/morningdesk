      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <motion.div
            ...
            animate={{ opacity: 1 }}
            onClick={() => navigate("/")}
            className={`flex-shrink-0 font-bold text-2xl cursor-pointer ${isDarkMode ? 'text-indigo-400' : 'text-indigo-600'
              }`}
          >
            MorningDesk
          </motion.div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`md:hidden absolute top-16 inset-x-0 ${isDarkMode ? 'bg-gray-900' : 'bg-white'
