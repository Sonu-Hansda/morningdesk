...
const CookieConsent: React.FC = () => {
    ...
    const handleManageCookies = () => {
        // Logic for managing cookies can be implemented here
    ...
    return (
        <div className={`fixed bottom-0 end-0 z-[60] w-full mx-auto p-6 backdrop-blur-sm ${isVisible ? 'bg-white/80' : 'bg-gray-900/90'}`}>
            {/* Card */}
                ...
                <div className="flex gap-x-5">
                    ...
                    <div className="grow">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            By clicking "Allow all", you agree to the use of all cookies. Visit our <a className="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">Cookies Policy</a> to learn more.
                        </p>
                        <div className="mt-5 block text-center md:inline-flex gap-x-2">
                            <button
                                type="button"
                            ...
                            <button
                                ...
                                className="py-2 px-3 mt-2 md:mt-0 mx-auto md:mx-auto block md:inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50"
                            >
                                Manage cookies
                            </button>
                        </div>
